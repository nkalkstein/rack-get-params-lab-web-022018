class Application
  ...
  def call(env)
    ...
    if req.path.match(/items/)
      ...
      resp.write handle_item(add_term)
    else
...
# Create a new route called /add that takes in a GET param with the key
# item. This should check to see if that item is in @@items and then
